...
#b[3] = 10
#print(b)
#revaluing elements doesn't work on tuples! They are IMMUTABLE.
...
#b.append(3)
#print(b)
#append doesn't work on tuples! They are IMMUTABLE.
...
print(sorted(x2)) #Sorts by first item in each tuple element (default).
print(sorted(x2, key=lambda s:s[1])) #Sorts by item at position 1 of each tuple element.
print(sorted(x2, key=lambda s:s[2])) #Sorts by item at position 2 of each tuple element.
print(sorted(x2, key=lambda s:s[2][1])) #Sorts by item at position 1 of item at position 2 of each tuple element.
...
print(sorted(x2, key=lambda s:s[0][1])) #Sorts by item at position 1 of item at position 0 of each tuple element (items at position 0 of each tuple element in this example are variables with values that are lists/tuple).
print(sorted(x2, key=lambda s:s[3][2][1])) #Sorts by item at position 1 of item at position 2 of item at position 3 of each tuple element (items at position 3 of each tuple element in this example are variables with values that are lists of strings). 
